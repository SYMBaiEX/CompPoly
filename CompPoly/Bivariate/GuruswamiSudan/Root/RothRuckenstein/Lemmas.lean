...
theorem composeYCoeff_eq_composeY_coeff {R : Type*}
  ...
  simpa [CPolynomial.Raw.eval, CPolynomial.Raw.eval₂] using (composeY_coeff_fold_eq Q.val p depth)
...
theorem composeYCoeff_monomial_zero_eq_composeY_coeff_zero {F : Type*}
  ...
  simpa [CPolynomial.Raw.eval, CPolynomial.Raw.eval₂] using (composeY_coeff_zero_fold_eq Q.val p)
